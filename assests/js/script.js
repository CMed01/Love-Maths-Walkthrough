...
/**
 * Gets the incurrent score from the DOM and increments it by 1
 */
...
function displaySubtractQuestion(operand1, operand2) {
    // Ternary statements are like if. The first part is the condition.
    // Followed by the question mark then the first part is whether 
    // the condition is truw and the second part will return if the condition is false.
